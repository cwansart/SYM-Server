...
('Pauli', 'Paulina', 'Giercza', 'Alles in Ordnung! :-)', '$2a$10$j.nc6PJ94ZdE5As97FoRGu1Md.HX2f7T2j9rsxSZrJwrdnclFOZLG'),
('stalker', 'Raphael', 'Grewe', 'Nix', '$2a$10$j.nc6PJ94ZdE5As97FoRGu1Md.HX2f7T2j9rsxSZrJwrdnclFOZLG');
...
('Larr', 2, NOW(), 'Hallo, ist wer hier?', NULL, 't'),
...
('Chris', 3, NOW(), 'Gehen zwei Atome in eine Bar, meint das eine zum anderen: "Ich glaub ich hab ein Elektron verloren", entgegnet das andere: "Sieh es positiv!"', NULL, 't'),
('Chris', 1, NOW(), 'Hallo, 123, ist das Mikro an?', NULL, 't'),
('Pauli', 1, NOW(), 'Ja, ich bin hier. ;-)', NULL, 't'),
...
('Chris', 6, NOW(), 'Hey, magst du sehen, wie toll unser Chat Bilder darstellen kann? :D', NULL, 't'),
('Larr', 6, NOW(), 'Klar gerne! :-)', NULL, 't'),
